...
class BackupController extends Controller
{
    ...
    public function store(BackupService $service){$backup=$service->creer();AuditService::manuel('backup','Création de la sauvegarde '.$backup['nom']);return back()->with('success','Sauvegarde créée et vérifiée.');}
